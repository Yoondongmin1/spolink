        ...
        <div class="u-container-style u-group u-palette-1-light-1 u-preserve-proportions u-radius u-shape-round u-group-1">
          <div class="u-container-layout u-container-layout-1">
            ...
            <div class="u-form u-form-1">
              <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-32 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
                ...
                <div class="u-form-group u-form-phone u-label-none u-form-group-5">
                  ...
                  <input type="tel" placeholder="전화번호를 입력해주세요" id="text-d0df" name="전화번호" class="u-grey-10 u-input u-input-rectangle u-radius u-input-5" required="required">
                </div>
            ...
            <div class="u-clearfix u-group-elements u-group-elements-1">
              <a href="#" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-radius u-white u-btn-2"><span class="u-file-icon u-icon u-text-custom-color-5 u-icon-1"><img src="${root }images/pngwing.com-5436c437.png" alt=""></span>&nbsp;NAVER
              </a>
              <a href="#" class="u-align-center u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-radius u-white u-btn-3"><span class="u-file-icon u-icon u-icon-2"><img src="${root }images/google_icon-removebg-preview.png" alt=""></span>&nbsp;Google
              </a>
              <a href="#" class="u-align-center u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-radius u-white u-btn-4"><span class="u-file-icon u-icon u-icon-3"><img src="${root }images/pngwing.com__2_-removebg-preview.png" alt=""></span>&nbsp;Kakaotalk
              </a>
            </div>
            <div class="u-clearfix u-group-elements u-group-elements-2">
              <p class="u-align-left u-text u-text-4">이미 회원 가입이 되​어있다면,</p>
              <a href="#" class="u-active-none u-border-3 u-border-no-left u-border-no-right u-border-no-top u-border-white u-btn u-btn-rectangle u-button-style u-hover-none u-none u-text-white u-btn-5">로그인 </a>
            </div>
          </div>
        </div>
      </div>
